...
// TES mesures
float wheelDiameter_mm = 60.6;   // rayon 3cm -> diamètre 6cm = 60mm
float trackWidth_mm    = 100.0;  // entraxe 21.3cm = 213mm
long  ticksPerRev      = 43;   // 1 tour de roue = 43 ticks (mesuré)
